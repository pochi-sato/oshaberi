...
> ⚠️ **2026-05-10 以降、このファイルはメンテナンスされていません。**
> 最新のソース / セットアップ手順は [README.md](./README.md) (clone & symlink 方式) を参照してください。
> このプロンプト方式は概念把握 / 雛形参考用として残しています (キャラランダム化 / Notification 対応など最新の変更は反映されていません)。
